...
/// <summary>
/// Representa un lote de notas factura que no puede
        ...
        Exception
{
    ...
    /// </summary>
    public ExcepcionLoteNotasFacturaNoProcesable(
        Guid loteId,
        string motivo,
        ...
        IReadOnlyCollection<string>? identificadores)
    {
        ...
        return
            $"El lote de notas factura '{loteId}' no " +
            $"puede procesarse. {motivo?.Trim()}" +
            detalle;
    }
}